...
namespace SV22T1020330.DataLayers.Interfaces
{
    /// <summary>
    ...
    public interface IOrderRepository
    {
        ...
        /// <returns></returns>
        /// 
        // Thêm phương thức lọc theo customerId
        Task<PagedResult<OrderViewInfo>> ListByCustomerAsync(OrderSearchInput input, int customerId);
