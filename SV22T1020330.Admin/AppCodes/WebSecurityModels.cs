...
namespace SV22T1020330.Admin
{
    ...
    public class WebUserRoles
    {
        ...
        /// <summary>
        /// All staff roles (can view products)
        /// </summary>
        public const string AllStaff = "admin,datamanager,sales";
        
        /// <summary>
        /// Admin and Manager roles (can manage products)
        /// </summary>
        public const string AdminManager = "admin,datamanager";
